...
can you write me a application using http4k to implement a backend for creating a simple e-commerce website that allow users:
  - to put and remove products in their cart,
  - to check the total
  - to do a checkout?
